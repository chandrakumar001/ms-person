...
class PersonValidatorSpec extends Specification {
    ...
    def "Failed::validatePersonDTO, personDTO Object"() {
        ...
        "The email is invalid format"     | personBareDTO("osaimar", "chandra", "kumar", "21")             || Optional.of("The 'EmailId' is invalid format")
        "The 'Age' is below 18"           | personBareDTO("osaimar19@gmail.com", "chandra", "kumar", "17") || Optional.of("The 'Age' must be 18")
